...
class CacheTests(unittest.TestCase):
    ...
    def test_tar_rejects_missing_partner_and_unexpected_suffix(self) -> None:
        # A partial pair or extra payload makes the immutable source archive non-canonical.
    ...
    def test_stale_partial_is_recovered_and_phase_reserved_rows_route_correctly(self) -> None:
        ...
        manifest = verify_cache(self.cache_root)
        self.assertEqual(manifest.phase_rows, {1: 1, 2: 1})
